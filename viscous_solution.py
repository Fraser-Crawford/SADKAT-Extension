...
spec = [
    ...
    ("diffusion",float64[:](float64[:]).as_type())
]

@jitclass(spec)
class ViscousSolution:
    ...
    def __init__(self, solvent, molar_mass_solute, num_ions, solubility_limit, solid_density, density, activity,
                 solid_refractive_index,diffusion):
